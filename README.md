...
Printing of "Hello World" by means of USART (Baud Rate 115200 Bits/s) using a buffer

# [USART Example 3](https://github.com/maxomous80/STM32_NUCLEO_F401RE/tree/master/USART%20Example%203)
Printing of "Test X" by means of USART (Baud Rate 115200 Bits/s) using a buffer and a variable (cont), whose value is dinamically inserted inside the buffer using the sprintf function
...
Output data can be viewed using Serial Plot from Arduino IDE or similar tools.
